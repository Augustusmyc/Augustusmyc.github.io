...
(lib.BellHTML5 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		function Diagram()
		{
			...
			qubit_mc = new lib.QubitMC();
			// qubit.width = 20;
			// qubit.height = 20;
			this.mc.addChild(qubit_mc);
			qubit_mc.addEventListener("pressmove", this.dragMe.bind(this));
		}
